...
import 'package:talabiapp/data/model/body/delivery_man_body.dart';
import 'package:talabiapp/data/model/body/store_body.dart';
import 'package:talabiapp/data/model/body/signup_body.dart';
import 'package:talabiapp/data/model/body/social_log_in_body.dart';
import 'package:talabiapp/data/model/response/delivery_man_vehicles.dart';
...
import 'package:talabiapp/data/model/response/zone_model.dart';
...
class AuthController extends GetxController implements GetxService {
  ...
  Future<ResponseModel> login(String? phone, String password, {bool alreadyInApp = false}) async {
    ...
    print("this the response data ${response.request} = ==  = = = == ==  == = = = = =  = ");
    ResponseModel responseModel;
    if (response.statusCode == 200) {
  ...
  void pickImage(bool isLogo, bool isRemove) async {
    if(isRemove) {
      ...
      if (isLogo) {
        _pickedLogo = await ImagePicker().pickImage(source: ImageSource.gallery,imageQuality: 20);
      } else {
        _pickedCover = await ImagePicker().pickImage(source: ImageSource.gallery,imageQuality: 20);
      }
      update();
    }
  }
  ...
  void pickDmImage(bool isLogo, bool isRemove) async {
    if(isRemove) {
      ...
      if (isLogo) {
        _pickedImage = await ImagePicker().pickImage(source: ImageSource.gallery,imageQuality: 20);
      } else {
