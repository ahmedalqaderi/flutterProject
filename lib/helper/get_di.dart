...
import 'package:talabiapp/controller/booking_checkout_controller.dart';
import 'package:talabiapp/controller/campaign_controller.dart';
import 'package:talabiapp/controller/car_selection_controller.dart';
import 'package:talabiapp/controller/cart_controller.dart';
import 'package:talabiapp/controller/category_controller.dart';
import 'package:talabiapp/controller/chat_controller.dart';
...
import 'package:talabiapp/controller/rider_controller.dart';
import 'package:talabiapp/controller/store_controller.dart';
import 'package:talabiapp/controller/search_controller.dart';
import 'package:talabiapp/controller/splash_controller.dart';
import 'package:talabiapp/controller/theme_controller.dart';
import 'package:talabiapp/controller/user_controller.dart';
import 'package:talabiapp/controller/wallet_controller.dart';
import 'package:talabiapp/controller/wishlist_controller.dart';
import 'package:talabiapp/data/repository/auth_repo.dart';
import 'package:talabiapp/data/repository/banner_repo.dart';
import 'package:talabiapp/data/repository/campaign_repo.dart';
import 'package:talabiapp/data/repository/car_selection_repo.dart';
import 'package:talabiapp/data/repository/cart_repo.dart';
import 'package:talabiapp/data/repository/category_repo.dart';
import 'package:talabiapp/data/repository/coupon_repo.dart';
import 'package:talabiapp/data/repository/language_repo.dart';
import 'package:talabiapp/data/repository/location_repo.dart';
import 'package:talabiapp/data/repository/notification_repo.dart';
import 'package:talabiapp/data/repository/onboarding_repo.dart';
import 'package:talabiapp/data/repository/order_repo.dart';
import 'package:talabiapp/data/repository/item_repo.dart';
import 'package:talabiapp/data/repository/parcel_repo.dart';
import 'package:talabiapp/data/repository/rider_repo.dart';
import 'package:talabiapp/data/repository/store_repo.dart';
import 'package:talabiapp/data/repository/search_repo.dart';
import 'package:talabiapp/data/repository/splash_repo.dart';
import 'package:talabiapp/data/api/api_client.dart';
import 'package:talabiapp/data/repository/user_repo.dart';
import 'package:talabiapp/data/repository/wallet_repo.dart';
import 'package:talabiapp/data/repository/wishlist_repo.dart';
