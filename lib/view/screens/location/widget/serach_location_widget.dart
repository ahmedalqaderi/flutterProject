...
import 'package:talabiapp/view/screens/location/widget/location_search_dialog.dart';
        ...
        child: Row(children: [
          ...
          Expanded(
            child: (pickedAddress != null && pickedAddress!.isNotEmpty) ? Text(
              pickedAddress!,
              style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeLarge,fontWeight: FontWeight.bold,color: Colors.red), maxLines: 1, overflow: TextOverflow.ellipsis,
            ) : Text(
              hint ?? '',
