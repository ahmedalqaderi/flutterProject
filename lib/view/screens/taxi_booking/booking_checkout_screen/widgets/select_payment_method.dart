...
import 'package:talabiapp/view/screens/taxi_booking/booking_checkout_screen/widgets/taxi_payment_button.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              TaxiPaymentButton(
                ...
                title: 'cash_on_delivery'.tr,
                subtitle: 'pay_your_payment_after_getting_item'.tr,
                isSelected: bookingCheckoutController.paymentMethodIndex == 4,
                onTap: () => bookingCheckoutController.setPaymentMethod(4),
              ),
