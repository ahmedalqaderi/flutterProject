...
import 'package:talabiapp/helper/custom_validator.dart';
...
import 'package:talabiapp/view/screens/auth/widget/condition_check_box.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:talabiapp/view/screens/auth/widget/pass_view.dart';
...
class SignUpScreenState extends State<SignUpScreen> {
         ...
         // color: Colors.green,
          child: Container(
            ...
            child: Stack(
              ...
              children: [
                Container(
                  alignment: Alignment.center,child: Image.asset(Images.logo, width: 200,fit: BoxFit.cover,)),
                // const SizedBox(height: Dimensions.paddingSizeSmall),
                 Container(
                  alignment: Alignment.center,
                  margin: EdgeInsets.only(left: 52,top: 83),    
                  

                   child: Container(
                    margin: EdgeInsets.only(),child: Text("قربنالك البعيد..", style: robotoMedium.copyWith(fontSize: 15,color: Theme.of(context).secondaryHeaderColor,fontWeight: FontWeight.bold))),
                 ),
              ],
            ),
          ),
                      ...
                      child: CustomTextField(
                        ...
                        onCountryChanged: (CountryCode countryCode) {
                          setState(() {
                           ...
                           print(" this the code  ${_countryDialCode}===============================");
                        },
                  ...
                  !ResponsiveHelper.isDesktop(context) ? CustomTextField(
                    titleText: 'البريد الالكتروني (اختياري)',
                    hintText: 'enter_email'.tr,
                    controller: _emailController,
                    focusNode: _emailFocus,
                    nextFocus: _passwordFocus,
  ...
  void _register(AuthController authController, String countryCode) async {
    ...
    //   showCustomSnackBar('invalid_phone_number'.tr);//note:(جزءالكودالذي يسمح باارقام ويمنع أرقام)
    // }
