...
import 'package:talabiapp/controller/coupon_controller.dart';
...
import 'package:talabiapp/data/model/response/cart_model.dart';
...
import 'package:talabiapp/view/base/custom_dropdown.dart';
...
import 'package:talabiapp/view/base/image_picker_widget.dart';
import 'package:talabiapp/view/base/menu_drawer.dart';
import 'package:talabiapp/view/base/not_logged_in_screen.dart';
import 'package:talabiapp/view/screens/address/widget/address_widget.dart';
import 'package:talabiapp/view/screens/cart/widget/delivery_option_button.dart';
import 'package:talabiapp/view/screens/checkout/widget/condition_check_box.dart';
import 'package:talabiapp/view/screens/checkout/widget/coupon_bottom_sheet.dart';
import 'package:talabiapp/view/screens/checkout/widget/delivery_instruction_view.dart';
import 'package:talabiapp/view/screens/checkout/widget/payment_method_bottom_sheet.dart';
import 'package:get/get.dart';
import 'package:google_maps_flutter/google_maps_flutter.dart';
import 'package:talabiapp/view/screens/checkout/widget/time_slot_bottom_sheet.dart';
...
import 'package:talabiapp/view/screens/store/widget/camera_button_sheet.dart';
import 'package:universal_html/html.dart' as html;
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;

import 'widget/payment_button_new.dart';
...
class CheckoutScreenState extends State<CheckoutScreen> {
  ...
  final TextEditingController identifynumber=TextEditingController();
              ...
              return GetBuilder<CouponController>(builder: (couponController) {
                return GetBuilder<OrderController>(builder: (orderController) {
                  ...
                  if(storeController.store != null && orderController.distance != null && orderController.distance != -1 && storeController.store!.selfDeliverySystem == 1) {
                    ...
                    pricetotal= orderController.distance! * storeController.store!.perKmShippingCharge!;
                    ...
                    charge = orderController.distance! * moduleData.perKmShippingCharge!;
                     pricetotal=charge;
                     //------------- addition by Eng : Ahmed & Abdulmoaz ----------------//

                    if(charge %100 <= 50 && charge % 100 !=0){
                      charge = charge - (charge % 100)+50 ;
                      pricetotal=charge;
                      deliveryCharge = charge;
                    

                    }else if(charge %100 > 50 ){
  ...
  //  if(orderController.isSwhing_Jawali==true)

  GetBuilder<OrderController>(builder: (controller) {
    if(controller.isSwhing_Jawalii){

return  controller.isSwhing_Jawalii?
  Container(
          ...
          decoration: BoxDecoration(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                orderController.changeIsShwoingJwalii(false);
                }, icon: Icon(Icons.clear)),
                Container(
                  width: MediaQuery.of(context).size.width,alignment: Alignment.center,
                  child: Image.asset(Images.cash,height: 100,width: 100,)),
                 // child: Image.asset("assets/image/scash.png",height: 100,width: 150,)),
                SizedBox(height: 6,),
               
                 Padding(
                   padding: const EdgeInsets.only(right: 29,left: 15),
 ...
 focusedBorder: OutlineInputBorder(
  ...
  padding: const EdgeInsets.only(right: 18,left: 15),                   
    child: Text("ادخل كود الشراء المولد من تطبيق فلوسك",
 ...
 orderController.changeIsShwoingJwalii(false);
  ...
  return  controller.isSwhing_Jawali?
          Container(
        //height: MediaQuery.of(context).size.height,
        width: MediaQuery.of(context).size.width,
        color: Colors.black54,
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                IconButton(onPressed: (){
                   ...
                   _phoneNumber.clear();
                  orderController.setPaymentMethod(1);
                orderController.changeIsShwoingJwali(false);
                }, icon: Icon(Icons.clear)),
                Container(
                  width: MediaQuery.of(context).size.width,alignment: Alignment.center,
                  
                  child: Image.asset(Images.jwali,height: 100,width: 100,)),

                  //child: Image.asset("assets/image/dm_icon.png",height: 100,width: 150,)),
                SizedBox(height: 4,),
                 Padding(
                   padding: const EdgeInsets.only(right: 29,left: 15),
                   child: Text("ادخل رقم الهاتف :",
      ...
      child: Column(children: [
        ...
        !takeAway ? Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Container(
              constraints: BoxConstraints(minHeight: ResponsiveHelper.isDesktop(context) ? 90 : 80),
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
    ...
    return Container(
      ...
      child: Column(children: [
        Container(
          ...
          // margin: const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeLarge, horizontal: Dimensions.paddingSizeLarge),
          child: Column(children: [
                          Container(
                            padding: EdgeInsets.only(right: 15),
                            alignment: Alignment.bottomRight,
                            width: MediaQuery.of(context).size.width,child: Text(widget.storeId != null ? 'payment_method'.tr : 'choose_payment_method'.tr, style: robotoMedium)),
 Container(
      width: 550,
      margin: EdgeInsets.only(top: GetPlatform.isWeb ? 0 : 10,left: 15,right: 15),
      decoration: BoxDecoration(
        color: Theme.of(context).cardColor,
      ...
      child: GetBuilder<OrderController>(
        builder: (orderController) {
          ...
          crossAxisAlignment: CrossAxisAlignment.start,children: [
            ...
            const SizedBox(height: Dimensions.paddingSizeSmall),
            _isCashOnDeliveryActive==true  ? PaymentButtonNew(
              icon: Images.codIcon,
            ...
            SizedBox(height: _isCashOnDeliveryActive==true ? Dimensions.paddingSizeSmall : 0),

            widget.storeId == null && _isDigitalPaymentActive==true? PaymentButtonNew(
            ...
            SizedBox(height: widget.storeId == null && _isDigitalPaymentActive==true ? Dimensions.paddingSizeSmall : 0),

            widget.storeId == null && _isWalletActive ? PaymentButtonNew(
              icon: Images.wallet,
...
// {
                          ...
                          // print("this the data after calling the function ${_isJwali} = = =  = = = = = = =");
                        // }
                        ,                      isJwaliActive: _isJwaliActive,
...
*/
              ...
              Text(
               ...
               Image.asset(
                orderController.paymentMethodIndex == 0 ? Images.codIcon : orderController.paymentMethodIndex == 1
                    ? Images.digitalPayment :orderController.paymentMethodIndex == 3?Images.jwali: Images.wallet,
                width: 20, height: 20,
                color: Theme.of(context).textTheme.bodyMedium!.color,
              ),
              const SizedBox(width: Dimensions.paddingSizeSmall),
              ...
              Expanded(
                child: Text(
                  orderController.paymentMethodIndex == 0 ? 'cash_on_delivery'.tr
                     : orderController.paymentMethodIndex == 1 ? 'digital_payment'.tr : orderController.paymentMethodIndex==3?'jwali'.tr:orderController.paymentMethodIndex==4?'فلوسك':'wallet_payment'.tr,
  ...
  void _callback(bool isSuccess, String? message, String orderID, int? zoneID, double amount, double? maximumCodOrderAmount) async {
    if(isSuccess) {
      _jawaliCode.text="";_jawaliCode.text="";
      if(widget.fromCart) {
          ...
          if(!_isCashOnDeliveryActive! && !_isDigitalPaymentActive! && !_isWalletActive) {
            ...
            if(widget.storeId == null){
              ...
              orderController.placeOrder(
                  PlaceOrderBody(
                    code: _jawaliCode.text.isNotEmpty?_jawaliCode.text:null,
                    phoneNumber: _phoneNumber.text.isNotEmpty?_phoneNumber.text:null,

                   

                    paymen_type: _jawaliCode.text.isNotEmpty&&_phoneNumber.text.isNotEmpty?2:null,
                ...
                paymentMethod:orderController.paymentMethodIndex==3?'cash_on_delivery': orderController.paymentMethodIndex == 0 ? 'cash_on_delivery'
                    : orderController.paymentMethodIndex == 1 ? 'digital_payment' :orderController.paymentMethodIndex==4?'cash_on_delivery': 'wallet',
