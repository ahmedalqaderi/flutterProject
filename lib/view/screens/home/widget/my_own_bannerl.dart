...
class MyOwnBannerl extends StatefulWidget {
  final bool isFeatured;
  bool isShowIndicator;
  bool isUnderPanner;
  double heigh;
    MyOwnBannerl({Key? key,this.isShowIndicator=false,this.heigh=290,this.isUnderPanner=false ,required this.isFeatured}) : super(key: key);

  @override
  State<MyOwnBannerl> createState() => _MyOwnBannerlState();
}

class _MyOwnBannerlState extends State<MyOwnBannerl> {
  @override
  Widget build(BuildContext context) {

    return GetBuilder<BannerController>(builder: (bannerController) {
      List<String?>? bannerList = widget.isFeatured ? bannerController.featuredBannerliftList : bannerController.bannerImageList;
      List<dynamic>? bannerDataList = widget.isFeatured ? bannerController.featuredBannerDataliftList : bannerController.bannerDataList;
