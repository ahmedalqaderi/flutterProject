...
class MyOwnBannerr extends StatefulWidget {
  final bool isFeatured;
  bool isShowIndicator;
  bool isUnderPanner;
  double heigh;
    MyOwnBannerr({Key? key,this.isShowIndicator=false,this.heigh=290,this.isUnderPanner=false ,required this.isFeatured}) : super(key: key);

  @override
  State<MyOwnBannerr> createState() => _MyOwnBannerrState();
}

class _MyOwnBannerrState extends State<MyOwnBannerr> {
  @override
  Widget build(BuildContext context) {

    return GetBuilder<BannerController>(builder: (bannerController) {
      List<String?>? bannerList = widget.isFeatured ? bannerController.featuredBannerrightList : bannerController.bannerImageList;
      List<dynamic>? bannerDataList = widget.isFeatured ? bannerController.featuredBannerDatarigthtList : bannerController.bannerDataList;
