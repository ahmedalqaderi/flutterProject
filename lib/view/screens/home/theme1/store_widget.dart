              ...
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  (store!.address != null) ? Text(
                    "${store?.address ?? ''}",
                    // "${store!.address!.length>20?store?.address?.substring(0,20):store?.address ?? ''}",
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        width: 70,
                        decoration: BoxDecoration(
                         color:store?.open==1? Theme.of(context).shadowColor:Colors.red,
                        ...
                        child: Text(store?.open==1?"مفتوح":"مغلق",
                        style: robotoRegular.copyWith(
