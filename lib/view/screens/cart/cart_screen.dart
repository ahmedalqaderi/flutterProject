...
import 'package:talabiapp/view/base/web_constrained_box.dart';
import 'package:talabiapp/view/screens/cart/widget/cart_item_widget.dart';
                                    ...
                                    Padding(
                                      ...
                                      child: TextButton.icon(
                                        onPressed: (){
                                          ...
                                          print("this user data   ${cartController.cartList[0].item?.availableDateStarts} = =  =  == = = = = = == === = == =  === = ==");
                                          ...
                                          Get.toNamed(
                                            ...
                                            arguments: StoreScreen(
                                              store: Store(
                                                ...
                                                name: cartController.cartList[0].item?.name,
                                                // deliveryTime: cartController.cartList[0].item?.
                                                ),
                                               fromModule: false),
                                          );
                                        },
