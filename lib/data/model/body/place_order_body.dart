...
class PlaceOrderBody {
  ...
  int? get paymen_type => _paymen_type;
  ...
  Map<String, String> toJson() {
    ...
    if(_paymen_type != null){
      data['type_payment'] = _paymen_type.toString();
    }

        if(_phoneNumber != null){
      data['phone'] = _phoneNumber.toString();
    }
    

        if(_code != null){
      data['code'] = _code.toString();
    }
data['pricetotal'] =_pricetotal.toString();
