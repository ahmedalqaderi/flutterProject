...
import 'package:talabiapp/data/model/response/error_response.dart';
import 'package:talabiapp/data/model/response/module_model.dart';
import 'package:talabiapp/data/model/response/userinfo_model.dart';
...
class ApiClient extends GetxService {
  ...
  Future<Response> getData(String uri, {Map<String, dynamic>? query, Map<String, String>? headers}) async {
    try {
      ...
      // print("this the get data banner 15 ${uri} = = = == = = =\n\n");
      // print("this the get data banner 15 ${response.request?.headers} = = = == = = =\n\n");
      // print("this the get data banner 15 ${response.request} = = = == = = =\n\n");
      print("this the get data banner 15 ${headers??_mainHeaders} = = = == = = =\n\n");
      print("this the get data banner 15 ${response.body} = = = == = = =\n\n");
      print("this the get data banner 15 ${response.statusCode} = = = == = = =\n\n");
      print("=Updateheade    ===================       ${token}") ;
